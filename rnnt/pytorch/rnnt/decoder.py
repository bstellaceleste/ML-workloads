...
#        print("Speedyloader: RNNTGreedyDecoder-init\n")
 ...
 #       print("Speedyloader: RNNTGreedyDecoder-pred_step\n")
  ...
  #      print("Speedyloader: RNNTGreedyDecoder-joint_step\n")
   ...
   #     print("Speedyloader: RNNTGreedyDecoder-decode\n")
    ...
    #    print("Speedyloader: RNNTGreedyDecoder-greedy_decode\n")
        return label
