...
class SegmentationMask(object):
    ...
    def transpose(self, method):
        ...
        print("bitchebe-------segmentation: ", time.time()-start_transpose)
    ...
    def crop(self, box):
        ...
        print("bitchebe-------segmentation: ", time.time()-start_crop)
    ...
    def resize(self, size, *args, **kwargs):
        ...
        print("bitchebe-------segmentation: ", time.time()-start_resize)
    ...
    def __getitem__(self, item):
        ...
        print("bitchebe-------segmentation: ", time.time()-start)
