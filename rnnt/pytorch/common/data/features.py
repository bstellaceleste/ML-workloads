...
class SpecAugment(BaseFeatures):
    ...
    def calculate_features(self, x, x_lens):
        ...
        tmp = x.masked_fill(mask, 0) + noise, x_lens

        # print("Speedyloader: SpecAugment = ",(time.time() - start) * 1000, "ms audio_lens = ",x_lens)
...
class FilterbankFeatures(BaseFeatures):
    ...
    def calculate_features(self, x, x_lens):
        ...
        # print("Speedyloader: FilterbankFeatures = ",(time.time() - start) * 1000, "ms audio_lens = ",x_lens)
...
class FrameSplicing(BaseFeatures):
    ...
    def calculate_features(self, x, x_lens):
        ...
        # print("Speedyloader: FrameSplicing = ",(time.time() - start) * 1000, "ms audio_lens = ",x_lens)
...
class FillPadding(BaseFeatures):
    ...
    def calculate_features(self, x, x_lens):
        ...
        # print("Speedyloader: FillPadding = ",(time.time() - start) * 1000, "ms audio_lens = ",x_lens)
